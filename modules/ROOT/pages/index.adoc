...
* https://medium.com/@werner.fouche/rest-api-load-testing-with-tulip-and-locust-75f28c00fa1f[REST API Load Testing with Tulip and Locust]

=== Releases

Mar 12, 2026::

* Tulip 2.3.0 released to new Maven Central location: https://mvnrepository.com/artifact/io.github.tulipltt/tulip-runtime
...
A Tulip-specific Log/Linear Quantized Histogram is used to provide a detailed view of the response times of actions. In the example below the benchmark results of two actions with average response times of 10ms and 20ms are shown.
...
----
<dependency>
   <groupId>io.github.tulipltt</groupId>
   <artifactId>tulip-runtime</artifactId>
   <version>2.3.0</version>
</dependency>
----
https://mvnrepository.com/artifact/io.github.tulipltt/tulip-runtime

.Gradle(Kotlin)
[source,kotlin]
----
implementation("io.github.tulipltt:tulip-runtime:2.3.0")
----
...
* https://github.com/tulipltt/Tulip/releases/tag/v2.3.0[Release Notes]
...
https://www.linkedin.com/company/108187552/admin/page-posts/published/[@Tulip_ltt]
