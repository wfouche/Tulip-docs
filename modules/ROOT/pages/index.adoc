...
Tulip was designed to champion Load Test-Driven (LTD) development. Traditionally, software load testing is delayed until the final phases of a project. LTD fundamentally shifts this focus by advocating for load testing to begin as early as possible in the software creation process, while still adhering to standard Test-Driven Development (TDD) best practices

Tulip empowers software engineers to start load testing their code on  day 1 of a project and not delay this important work until day N-10. See the following blog post for more information about LTD:
...
[source,kotlin]
----
implementation("io.github.wfouche.tulip:tulip-runtime:2.1.12")
----
...
* https://github.com/wfouche/Tulip/milestone/13?closed=1[Feature list]
...
* https://github.com/wfouche/Tulip/milestone/12?closed=1[Feature list]

* Release date: 23 September 2025

Tulip v2.1.10::

* https://github.com/wfouche/Tulip/milestone/11?closed=1[Feature list]
...
* https://github.com/wfouche/Tulip/milestone/14[Feature list]
