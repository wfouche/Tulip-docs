...
In this test we're going to send http request at a rate of 5.0 requests per second (rps) to <jsonplaceholder>/posts/1.
...
Open the `kwrk_report.html` file in a browser to view the benchmark results.
